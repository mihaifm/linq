...
return b};d.prototype.firstOrDefault=function(a,b){if(a){if("function"===typeof a||"function"===typeof e.createLambda(a))return this.where(a).firstOrDefault(null,b);b=a}b=b||null;var c,d=!1;this.forEach(function(a){c=a;d=!0;return!1});return d?c:b};d.prototype.last=function(a){if(null!=a)return this.where(a).last();var b,c=!1;this.forEach(function(a){c=!0;b=a});if(!c)throw Error("last:No element satisfies the condition.");return b};d.prototype.lastOrDefault=function(a,b){if(a){if("function"===typeof a||
"function"===typeof e.createLambda(a))return this.where(a).lastOrDefault(null,b);b=a}b=b||null;var c,d=!1;this.forEach(function(a){d=!0;c=a});return d?c:b};d.prototype.single=function(a){if(null!=a)return this.where(a).single();var b,c=!1;this.forEach(function(a){if(c)throw Error("single:sequence contains more than one element.");c=!0;b=a});if(!c)throw Error("single:No element satisfies the condition.");return b};d.prototype.singleOrDefault=function(a,b){b===p&&(b=null);if(null!=a)return this.where(a).singleOrDefault(null,
